...
public class CookieAuthenticator extends AbstractAuthenticationModule {
    ...
    public ModuleFields loadModule(URI relativeURI, String httpMethod, byte[] requestBody) {
        ...
        AuthorizationFields authzFields = getAuthorizationFields(null, null, null);
        
        fields.setHeaders(authzFields.getHeaders());
        fields.setQueryParameters(authzFields.getHeaders());
